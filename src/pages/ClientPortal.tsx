...
const dashboardFeatures = [
  {
    icon: Home,
    title: "Mes biens",
    description: "Gérez vos propriétés, suivez les loyers et les charges",
  },
  {
    icon: FileText,
    title: "Documents",
    description: "Accédez à tous vos contrats, factures et décomptes",
  },
  {
    icon: CreditCard,
    title: "Paiements",
    description: "Consultez votre historique et programmez vos virements",
  },
  {
    icon: Bell,
    title: "Notifications",
    description: "Restez informé des échéances et actualités importantes",
  },
];
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
                ...
                <div className="mb-8 text-center">
                  ...
                  <p className="mt-2 text-muted-foreground">
                    {isLogin
                      ...
                      : "Rejoignez la communauté ImmoTrust"}
                  </p>
                </div>
            ...
            >
              ...
              <p className="mt-4 text-muted-foreground">
                Accédez à l'ensemble de vos informations immobilières, documents
                et communications en quelques clics.
              </p>
